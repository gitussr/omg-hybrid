...
/* The inner /omg-entertainment/ landing page uses the "framed" card
 * treatment (centred, primary border, circular badge). The home page is
 * left isolated on the plain variant per instruction. */
$framed = ( $args['context'] ?? '' ) === 'landing';
