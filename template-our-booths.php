...
<section class="private-party-section">
    <div class="container">
        ...
        ?>
        <div class="main-block" id="booth-<?php echo $key; ?>" style="scroll-margin-top: 200px;">
            <div class="row">
                <div class="col-lg-6">
...
<?php echo get_template_part('booth-gallery-section'); ?>
...
<section class="logoMarqueeSection">
    ...
    <div class="container" id="logoMarqueeSection">
        ...
        <div class="default-content-container-inner marquee-wrapper marque-1 marquee-dir-left">
